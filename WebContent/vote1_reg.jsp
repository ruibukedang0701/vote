...
<body >
	...
	<center>
		<table id="table1">
			...
			<tr>
				<td><input id="id1" type="text" style="font-size: 30px"></input></td>

			</tr>
			<tr>
				<td style="font-size: 30px">姓名：</td>
			</tr>
			<tr>
				<td><input id="name1" type="text" style="font-size: 30px"></input></td>
			</tr>
			<tr>
			...
			<tr>
				<td><input id="passwd1" type="password" style="font-size: 30px"></input></td>
			</tr>
			<tr>
				<td><input type="button"
					style="float: right; position: relative; font-size: 30px;background-color:transparent;"
					value="注册" onclick="reg();"></input></td>
			</tr>
		</table>
	</center>
	...
	<script language="javascript">
		function reg() {
			var theid = id1.value;
			var thename = name1.value;
			var thepwd = passwd1.value;
			var xmlhttp;
					...
					if (thepwd.match('[0-9a-zA-Z]{6}')) {
						...
						xmlhttp.onreadystatechange = function() {
							...
							if (xmlhttp.readyState == 4
								...
								if (getString[0] == "0") {
									alert(getString[1] + "注册成功");
									window.location.href = "vote1_log.jsp";
						...
						xmlhttp.open("GET", "/vote/forreg?theid="
								+ escape(theid) + "&thename=" + thename
